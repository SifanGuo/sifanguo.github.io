...
`The [Bandit wargame](http://overthewire.org/wargames/bandit/) is aimed at absolute beginners. It will teach the basics needed to be able to play other wargames.`
...
Output: A lot of lines, but we can find this line
